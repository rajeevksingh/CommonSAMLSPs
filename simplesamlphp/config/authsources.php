...
$config = array(
    ...
    'uat-bisaccount-sp' => array(
        'saml:SP',
        'certificate' => 'bizsp1.crt',
        'privatekey' => 'bizsp1.pem',
        'entityID' => 'uat-bisaccount-sp',

        // The entity ID of the IdP this should SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'https://uat.signin.bisaccount.mycas.org.uk/biz-idp/shibboleth',
    ...
    'uat-myaccount-sp' => array(
        'saml:SP',
        'certificate' => 'myaccountsp1.crt',
        'privatekey' => 'myaccountsp1.pem',
        'entityID' => 'uat-myaccount-sp',

        // The entity ID of the IdP this should SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'https://uat.signin.mycas.org.uk/idp/shibboleth',
